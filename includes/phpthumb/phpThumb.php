...
//artista
$pos_artista= strpos($_GET["src"], "/a_");

if ($pos_artista!==false) {
	if ($_GET['w']>620) die("sorry ;( 1");
	if ($_GET['h']>1000) die("sorry ;( 2");
}

$pos_projeto= strpos($_GET["src"], "/p_");

if ($pos_projeto!==false) {
	if ($_GET['w']>1000) die("sorry ;( 3");
	if ($_GET['h']>1000) die("sorry ;( 4");
}


$_GET["src"]= "../../../curador/uploads". $_GET["src"];
